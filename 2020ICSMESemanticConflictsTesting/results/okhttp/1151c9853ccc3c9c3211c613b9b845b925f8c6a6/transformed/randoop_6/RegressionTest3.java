...
// flaky:         org.junit.Assert.assertTrue("'" + int92 + "' != '" + 100 + "'", int92 == 100);
    ...
    public void test1513() throws Throwable {
        ...
        int int30 = gzipSource7.section;
        int int31 = gzipSource7.section;
        gzipSource0.source = gzipSource7;
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + int3 + "' != '" + 100 + "'", int3 == 100);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertNull(inflaterSource4);
...
// flaky:         org.junit.Assert.assertTrue("'" + int31 + "' != '" + 100 + "'", int31 == 100);
    ...
    public void test1514() throws Throwable {
        ...
        int int32 = gzipSource31.section;
        com.squareup.okhttp.internal.bytes.GzipSource gzipSource33 = new com.squareup.okhttp.internal.bytes.GzipSource();
        java.util.zip.Inflater inflater34 = null;
        gzipSource33.inflater = inflater34;
        int int36 = gzipSource33.section;
        ...
        gzipSource33.require((int) (short) -1, deadline41);
        com.squareup.okhttp.internal.bytes.GzipSource gzipSource43 = new com.squareup.okhttp.internal.bytes.GzipSource();
        java.util.zip.Inflater inflater44 = null;
        gzipSource43.inflater = inflater44;
        int int46 = gzipSource43.section;
        ...
        com.squareup.okhttp.internal.bytes.InflaterSource inflaterSource52 = gzipSource43.inflaterSource;
        gzipSource33.source = gzipSource43;
        ...
        com.squareup.okhttp.internal.bytes.InflaterSource inflaterSource55 = null;
        gzipSource43.inflaterSource = inflaterSource55;
        com.squareup.okhttp.internal.bytes.OkBuffer okBuffer57 = gzipSource43.buffer;
        gzipSource31.buffer = okBuffer57;
        com.squareup.okhttp.internal.bytes.Deadline deadline60 = null;
        // The following exception was thrown during execution in test generation
        try {
            long long61 = gzipSource19.read(okBuffer57, 1L, deadline60);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
...
// flaky:         org.junit.Assert.assertTrue("'" + int3 + "' != '" + 100 + "'", int3 == 100);
    ...
    public void test1516() throws Throwable {
        ...
        com.squareup.okhttp.internal.bytes.OkBuffer okBuffer9 = null;
        // The following exception was thrown during execution in test generation
        try {
            gzipSource0.updateCrc(okBuffer9, 0L, (long) 97);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
        // Expected exception.
        }
...
// flaky:         org.junit.Assert.assertTrue("'" + int8 + "' != '" + 100 + "'", int8 == 100);
    ...
    public void test1517() throws Throwable {
        ...
        com.squareup.okhttp.internal.bytes.InflaterSource inflaterSource39 = gzipSource38.inflaterSource;
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + int3 + "' != '" + 100 + "'", int3 == 100);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertNull(inflaterSource4);
...
// flaky:         org.junit.Assert.assertTrue("'" + int22 + "' != '" + 100 + "'", int22 == 100);
    ...
    public void test1518() throws Throwable {
        ...
        // The following exception was thrown during execution in test generation
        try {
            gzipSource8.consumeHeader(deadline21);
            org.junit.Assert.fail("Expected exception of type java.io.EOFException; message: null");
        } catch (java.io.EOFException e) {
        // Expected exception.
        }
...
// flaky:         org.junit.Assert.assertTrue("'" + int14 + "' != '" + 100 + "'", int14 == 100);
    ...
    public void test1519() throws Throwable {
        ...
        int int43 = gzipSource27.section;
        java.util.zip.CRC32 cRC32_44 = gzipSource27.crc;
        com.squareup.okhttp.internal.bytes.Source source45 = gzipSource27.source;
        int int46 = gzipSource27.section;
        java.util.zip.Inflater inflater47 = gzipSource27.inflater;
        gzipSource10.inflater = inflater47;
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + int3 + "' != '" + 100 + "'", int3 == 100);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertNull(inflaterSource4);
