...
public class RegressionTest1 {
    ...
    public void test781() throws Throwable {
        ...
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + str1 + "' != '" + "_tsetd" + "'", str1.equals("_tsetd"));
    }
    ...
    public void test790() throws Throwable {
        ...
        org.junit.Assert.assertNull(codeGenerator13);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + str16 + "' != '" + "\"\"\"0\"Context\"\"" + "'", str16.equals("\"\"\"0\"Context\"\""));
    }
    ...
    public void test793() throws Throwable {
        ...
        int int86 = python2Target0.getInlineTestSetWordSize();
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + int1 + "' != '" + 64 + "'", int1 == 64);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertNotNull(strArray5);
    ...
    public void test795() throws Throwable {
        ...
        org.junit.Assert.assertNotNull(strArray49);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + str54 + "' != '" + "d" + "'", str54.equals("d"));
    }
    ...
    public void test801() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + str26 + "' != '" + "\"i\"" + "'", str26.equals("\"i\""));
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + str29 + "' != '" + "\"\"\\12Context\"\"" + "'", str29.equals("\"\"\\12Context\"\""));
    }
