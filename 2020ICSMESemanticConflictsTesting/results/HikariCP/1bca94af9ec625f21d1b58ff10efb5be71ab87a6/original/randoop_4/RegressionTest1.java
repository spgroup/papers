...
// flaky:         org.junit.Assert.assertTrue("'" + str12 + "' != '" + "HikariPool-2542" + "'", str12.equals("HikariPool-2542"));
    ...
    public void test0957() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int5 + "' != '" + 60 + "'", int5 == 60);
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + str6 + "' != '" + "HikariPool-2580" + "'", str6.equals("HikariPool-2580"));
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + int7 + "' != '" + 60 + "'", int7 == 60);
    }
    ...
    public void test0973() throws Throwable {
        ...
        org.junit.Assert.assertNull(dataSource11);
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + str14 + "' != '" + "HikariPool-2606" + "'", str14.equals("HikariPool-2606"));
    }
    ...
    public void test0981() throws Throwable {
        ...
        org.junit.Assert.assertNull(str3);
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + str8 + "' != '" + "HikariPool-2619" + "'", str8.equals("HikariPool-2619"));
    }
    ...
    public void test0992() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + true + "'", boolean6 == true);
        // Regression assertion (captures the current behavior of the code)
// flaky:         org.junit.Assert.assertTrue("'" + str7 + "' != '" + "HikariPool-2632" + "'", str7.equals("HikariPool-2632"));
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertNull(str10);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + long11 + "' != '" + 5000L + "'", long11 == 5000L);
    ...
    public void test0994() throws Throwable {
        ...
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 1 + "'", int6 == 1);
        // Regression assertion (captures the current behavior of the code)
        org.junit.Assert.assertTrue("'" + str11 + "' != '" + "HikariPool-697" + "'", str11.equals("HikariPool-697"));
    }
