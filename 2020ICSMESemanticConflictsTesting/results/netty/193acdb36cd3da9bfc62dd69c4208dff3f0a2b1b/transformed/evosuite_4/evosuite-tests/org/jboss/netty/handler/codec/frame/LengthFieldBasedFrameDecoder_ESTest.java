...
public class LengthFieldBasedFrameDecoder_ESTest extends LengthFieldBasedFrameDecoder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      // Original Version:
      //     org.evosuite.runtime.mock.java.lang.MockIllegalArgumentException : lengthFieldLength must be either 1, 2, 3, 4, or 8: -791
      // Modified Version:
      ...
      try {
        lengthFieldBasedFrameDecoder0 = new LengthFieldBasedFrameDecoder(93, 93, (-791), (-791), 1048576, true);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // lengthFieldLength must be either 1, 2, 3, 4, or 8: -791
         //
         verifyException("org.jboss.netty.handler.codec.frame.LengthFieldBasedFrameDecoder", e);
         assertTrue(e.getMessage().equals("lengthFieldLength must be either 1, 2, 3, 4, or 8: -791"));   
      }
  }
}
