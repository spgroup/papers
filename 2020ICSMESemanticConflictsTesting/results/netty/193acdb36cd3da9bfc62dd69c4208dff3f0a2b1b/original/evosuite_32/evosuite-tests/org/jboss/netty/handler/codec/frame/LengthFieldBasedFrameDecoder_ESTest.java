...
public class LengthFieldBasedFrameDecoder_ESTest extends LengthFieldBasedFrameDecoder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      // Original Version:
      //     org.evosuite.runtime.mock.java.lang.MockIllegalArgumentException : lengthFieldLength must be either 1, 2, 3, 4, or 8: 1755
      // Modified Version:
      ...
      try {
        lengthFieldBasedFrameDecoder0 = new LengthFieldBasedFrameDecoder(8, 8, 1755, 130, 4, false);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // lengthFieldLength must be either 1, 2, 3, 4, or 8: 1755
         //
         verifyException("org.jboss.netty.handler.codec.frame.LengthFieldBasedFrameDecoder", e);
         assertTrue(e.getMessage().equals("lengthFieldLength must be either 1, 2, 3, 4, or 8: 1755"));   
      }
  }
}
