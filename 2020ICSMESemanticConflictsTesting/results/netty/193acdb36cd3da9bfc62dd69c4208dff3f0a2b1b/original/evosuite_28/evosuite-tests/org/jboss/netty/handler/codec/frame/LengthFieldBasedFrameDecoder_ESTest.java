...
public class LengthFieldBasedFrameDecoder_ESTest extends LengthFieldBasedFrameDecoder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      // Original Version:
      //     org.evosuite.runtime.mock.java.lang.MockIllegalArgumentException : maxFrameLength must be a positive integer: 0
      // Modified Version:
      ...
      try {
        lengthFieldBasedFrameDecoder0 = new LengthFieldBasedFrameDecoder(0, 0, 4400, 0, 4400, false);
        fail("Expecting exception: IllegalArgumentException");
         ...
         assertTrue(e.getMessage().equals("maxFrameLength must be a positive integer: 0"));   
      }
  }
}
