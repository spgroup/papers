...
# ----------------------------
# Gera o PDF com a saída do script
# ----------------------------
print_output = buffer.getvalue()  # Captura a saída
buffer.close()
sys.stdout = sys.__stdout__  # Restaura stdout

# Gera imagem com matplotlib
fig, ax = plt.subplots(figsize=(8.5, len(print_output.splitlines()) / 6))
ax.axis("off")
ax.text(0, 1, print_output, fontsize=10, va='top', family="monospace")
